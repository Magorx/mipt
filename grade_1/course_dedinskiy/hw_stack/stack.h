...
int STACK_GENERIC(recalculate_hash)(STACK_GENERIC_TYPE *cake) {
...
int STACK_GENERIC(is_empty)(const STACK_GENERIC_TYPE *cake) {
    STACK_OK(cake);
    return STACK_GENERIC(size)(cake) == 0;
}

int STACK_GENERIC(is_full)(const STACK_GENERIC_TYPE *cake) {
    STACK_OK(cake);
