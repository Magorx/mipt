...
inline m256::operator const char*() const {
	return (const char*) c;
}

inline m256::operator char*() const {
	return (char*) c;
}

inline m256::operator const void*() const {
	return (const void*) this;
}

inline m256::operator void*() const {
	return (void*) this;
}
